package me.dio.santanderapinuvem.config;
...
public class SwaggerConfig {
	@Value("${bruno.openapi.dev-url}")
	private String devUrl;

	@Value("${bruno.openapi.prod-url}")
	...
	public OpenAPI myOpenAPI() {
		...
		Info info = new Info().title("API registrer for users with account").version("1.0").contact(contact)
